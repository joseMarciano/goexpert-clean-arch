...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ListOrderResponse, error) {
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *Void) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *Void) (*ListOrderResponse, error) {
...
func _OrderService_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrder(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
